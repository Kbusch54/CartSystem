	...
	public static void main(String[] args) throws IOException {
		...
		while (choice != 7) {
			...
			case 2:
				...
				if(cart.checkAvailability(app.getItemCollection().get(itemName))) {
				if (cart.add(app.getItemCollection().get(itemName))) {
					System.out.println("Item successfully added");
				} else {
			...
			case 6:
				...
				if(itemName!=null) {
					...
					System.out.println(itemName + " was removed from the System");
				app.remove(itemName); 

					if (cart.remove(itemName) != null) {
						System.out.println(itemName + " was also removed from the cart");
					}
